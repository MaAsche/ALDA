...
import aufgabe3.graph.AdjacencyListDirectedGraph;
...
public class ScotlandYard {
     ...
     */
    private static DirectedGraph<Integer> getGraph() throws FileNotFoundException {
...
class ScotlandYardHeuristic implements Heuristic<Integer> {
    ...
    ScotlandYardHeuristic() throws FileNotFoundException {
        coord = new TreeMap<>();
        read();
    }
