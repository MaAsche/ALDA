...
public class DictionaryTest {
    ...
    private static void testDict(Dictionary<String, String> dict) {
        ...
        System.out.println("1: " + (dict.insert("gehen", "go") == null));     // true
        String s = new String("gehen");
        System.out.println("2: " + (dict.search(s) != null));                 // true
        System.out.println("3: " + dict.search(s).equals("go"));            // true
        System.out.println("4: " + dict.insert(s, "walk").equals("go"));    // true
        System.out.println("5: " + dict.search("gehen").equals("walk"));    // true
        System.out.println("6: " + dict.remove("gehen").equals("walk"));    // true
        System.out.println("7: " + (dict.remove("gehen") == null));
